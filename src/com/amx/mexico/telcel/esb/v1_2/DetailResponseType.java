 ...
 */
                ...
                */
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           protected boolean localSeverityLevelTracker = false ;

                           public boolean isSeverityLevelSpecified(){
                               return localSeverityLevelTracker;
                           }
                           ...
                           */
                           public  com.amx.mexico.telcel.esb.v1_2.SeverityType getSeverityLevel(){
                            ...
                            localSeverityLevelTracker = param != null;
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localBusinessMeaningTracker = false ;

                           public boolean isBusinessMeaningSpecified(){
                               return localBusinessMeaningTracker;
                           }
                           ...
                           */
                           public  com.amx.mexico.telcel.esb.v1_2.MeaningType getBusinessMeaning(){
                            ...
                            localBusinessMeaningTracker = param != null;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DetailResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DetailResponseType",
                           xmlWriter);
                                         ...
                                         if (localActorTracker){
                                           ...
                                           localActor.serialize(new javax.xml.namespace.QName("http://amx.com/mexico/telcel/esb/v1_2","actor"),
                                               xmlWriter);
                                        } if (localBusinessMeaningTracker){
    ...
    public static class Factory{
        ...
        */
        public static DetailResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DetailResponseType object =
                new DetailResponseType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DetailResponseType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DetailResponseType)mx.com.amx.www.mexico.telcel.di.sds.bes.ti.consultasaldo.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
